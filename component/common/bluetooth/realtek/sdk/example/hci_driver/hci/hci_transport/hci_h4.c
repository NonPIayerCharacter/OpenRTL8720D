...
static uint8_t h4_open(void)
{
    ...
    hci_h4->rx_run = 1;
	//tuya £¨increasing stack depth to prevent overflow£©
    osif_task_create(&hci_h4->rx_thread_hdl, "h4_rx_thread", h4_rx_thread, 0, CONFIG_HCI_RX_STACK_SIZE*2, CONFIG_HCI_RX_PRIO);
